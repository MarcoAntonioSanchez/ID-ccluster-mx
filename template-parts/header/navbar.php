        ...
        <div class="hidden items-center gap-8 md:flex">
            ...
            <?php if (
                ...
                <a
                    ...
                    class="flex gap-[5px] bg-[#0F143A] px-6 py-3 text-sm font-semibold text-white capitalize duration-300 ease-in-out hover:scale-[1.05] hover:shadow-md hover:gap-[10px]">
                    <span class="self-center ccluster-cta__icon">
