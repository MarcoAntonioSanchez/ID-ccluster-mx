...
<section
    id="home-hero"
    class="ccluster-hero relative overflow-hidden bg-cover bg-center bg-no-repeat"
    ...
    <div
        ...
        <div class="text-left">
                ...
                <div class="mb-6 flex items-center gap-3">
                    <?php if ($hero_badge_icon) : ?>
                        <img
                            ...
                            alt=""
                            class="h-[28px] w-[28px] shrink-0 object-contain">
                    <?php endif; ?>
                    <span
            ...
            <?php endif; ?>
            <?php if ($hero_title) : ?>
                <h1 class="max-w-2xl text-4xl font-bold capitalize leading-tight md:text-6xl font-heading">
